                                                            ...
                                                            <table id="example" class="table table-bordered"
                                                                ...
                                                                <tr role="row">
                                                                    <th class="sorting_desc" tabindex="0"
                                                                        ...
                                                                        style="width: 98.2969px;">Mã User
                                                                    </th>
                                                                    <th class="sorting" tabindex="0"
                                                                        aria-controls="example" rowspan="1" colspan="1"
                                                                        aria-label="Tên đăng nhập: activate to sort column ascending"
                                                                        style="width: 485.891px;">Tên đăng nhập
                                                                    </th>
                                                                    <th class="sorting" tabindex="0"
                                                                        aria-controls="example" rowspan="1" colspan="1"
                                                                        aria-label="Họ và tên: activate to sort column ascending"
                                                                        style="width: 171.672px;">Họ và tên
                                                                    </th>
                                                                    <th class="sorting" tabindex="0"
                                                                        aria-controls="example" rowspan="1" colspan="1"
                                                                        aria-label="Bút danh: activate to sort column ascending"
                                                                        style="width: 171.672px;">Bút danh
                                                                    </th>
                                                                    <th class="sorting" tabindex="0"
                                                                        aria-controls="example" rowspan="1" colspan="1"
                                                                        aria-label="Email: activate to sort column ascending"
                                                                        style="width: 171.672px;">Email
                                                                    </th>
                                                                    <th class="sorting" tabindex="0"
                                                                        aria-controls="example" rowspan="1" colspan="1"
                                                                        aria-label="Xóa: activate to sort column ascending"
                                                                        style="width: 171.672px;">Xoá
                                                                    </th>
                                                                </tr>
                                                                </thead>

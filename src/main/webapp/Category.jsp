                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="form-valide-with-icon" action="AddCategory" method="POST"
                                            ...
                                            <span class="input-group-text"> <i class="fa fa-header"
                                                                               aria-hidden="true"></i>
                                            </span>
                                                        </div>
                                                        <input type="text" class="form-control" name="name"
                                                               placeholder="Tên danh mục chính" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form-valide-with-icon" action="AddSubCategory" method="POST"
                                          novalidate="novalidate">
                                        <div class="form-group">
                                            <div class="form-group">
                                            ...
                                            <span class="input-group-text"> <i class="fa fa-header"
                                                    ...
                                                    <input type="text" class="form-control" name="parent_id"
                                                           placeholder="Mã danh mục chính" value="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group">
                                            ...
                                            <span class="input-group-text"> <i class="fa fa-header"
                                                        ...
                                                        <input type="text" class="form-control" name="name"
                                                               placeholder="Tên danh mục phụ" value="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                </div>

                        ...
                        <ul class="pagination">
                            <c:if test="${page != 1}">
                                <li class="paginate_button page-item" id="dataTable_previous">
                                    <a href="${pageContext.request.contextPath}/TrangChu/ShowArticleByCat?catId=${catId}&page=${page - 1 }" aria-controls="dataTable" data-dt-idx="0" tabindex="0" class="page-link">Previous</a>
                                </li>
                            </c:if>
                                ...
                                <c:choose>
                                    <c:when test="${ page == i}">
                                        <li class="paginate_button page-item active">
                                            <a href="${pageContext.request.contextPath}/TrangChu/ShowArticleByCat?catId=${catId}&page=${i}" aria-controls="dataTable"  tabindex="0" class="page-link">${ i}</a>
                                        </li>
                                    </c:when>
                                    <c:otherwise>
                            ...
                            <c:if test="${page < totalpage}">
                                <li class="paginate_button page-item next" id="dataTable_next">
                                    <a href="${pageContext.request.contextPath}/TrangChu/ShowArticleByCat?catId=${catId}&page=${page + 1}" aria-controls="dataTable"  tabindex="0" class="page-link">Next</a>
                                </li>
                            </c:if>
                        </ul>
                    </div>

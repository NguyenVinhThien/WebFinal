    ...
    <div class="noibat">
      ...
      <div class="groupCard">
        <c:forEach items="${listTopHotArt}" var="lh">
          <div class="cardInfo">
            <img class="cardImg" src="${lh.headline_image}" alt="Card image cap">
            <div class="card-body">
              <h5 >
        ...
        <div class="newPost">
          ...
          <c:forEach items="${listNewArt}" var="ln">
            <div class="horizontalCard">
              <img src="${ln.headline_image}" alt="" class="cardHorizontalImg">
...
<%--                </c:choose>--%>
        ...
        <div class="top10">
          ...
          <c:forEach items="${listTopByCat}" var="ltc">
            <div class="horizontalCard">
              <img src="${ltc.headline_image}" alt="" class="cardHorizontalImg">
              <div class="cardHorizontal-Body">
                <h5 >
